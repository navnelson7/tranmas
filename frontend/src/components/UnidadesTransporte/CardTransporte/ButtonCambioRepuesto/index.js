...
function ButtonCambioRepuesto({ idUnidadTransporte }) {
  return (
    <Fragment>
      <StyleLoaderEspera>
        <Link
          title="Alertas de cambio de repuesto"
          to={`/alertas/cambio/repuesto/${idUnidadTransporte}`}
        >
...
export default ButtonCambioRepuesto;
