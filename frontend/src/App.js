...
// LAZY IMPORTS
const PapeleraRepuestos = lazy(() =>
  import("./components/Repuestos/Papelera/ListadoRepuestos")
);
const ReporteEdificios = lazy(() =>
  import("./components/UnidadesTransporte/Reportes/ReporteEdificios")
);
...
const TableDañoEdificio = lazy(() =>
  import("./components/Edificios/RegistroDañosEdificios/TableDañoEdificio")
);
      ...
      <Router>
        <SearchContextProvider>
          ...
          <Switch>
            ...
            <Route exact path="/editar/daño/edificio/:id">
              <Suspense fallback={<Loader />}>
                <EditarDañoEdificio />
              </Suspense>
            </Route>
            <Route exact path="/tabla/daño/edificio">
              <Suspense fallback={<Loader />}>
                <TableDañoEdificio />
              </Suspense>
            </Route>
            ...
            <Route exact path="/reporte/aire/acondicionado/:idUnidadTransporte">
              <Suspense fallback={<Loader />}>
            ...
            <Route exact path="/papelera/repuestos">
              <Suspense fallback={<Loader />}>
                <PapeleraRepuestos />
              </Suspense>
            </Route>
